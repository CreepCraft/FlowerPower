...
public class FlowerPower extends JavaPlugin
	{
		...
		public void onDisable() {
			log.info("FlowerPower" + "version" + getDescription().getVersion() + " by iPhysX, iPencil & Kohle" + " disabled!");
		...
		public void onEnable() {
			...
			log.info("FlowerPower" + "version" + getDescription().getVersion() + " by iPhysX, iPencil & Kohle" + " enabled!");
